...
본 저장소는 Team Nature Republic이 개발한 **Boarding Pass** 프로젝트를 담고 있습니다.
  
**Boarding Pass**는 **신규 입사자가 겪는 온보딩 과정의 어려움을 해결하기 위해 설계된 NLP 기반 문서 이해 챗봇 시스템**입니다.

본 프로젝트는 **2023 KPMG Ideathon**에서 **Top 11 Finalist**로 선정되었습니다.
...
**Boarding Pass**는 사내에 흩어진 문서를 기반으로 사용자의 질문에 필요한 정보를 찾아 제공하는 챗봇입니다.

문서를 일일이 확인해야 하는 불편함을 줄이고, 입사 초기와 협업 과정에서 필요한 정보를 빠르게 파악할 수 있도록 개발했습니다.
...
**Team Nature Republic**은 자연어처리에 대한 관심을 바탕으로 자발적으로 결성된 팀입니다.
  
문헌정보학, 소프트웨어공학 전공자가 함께 참여했으며, 전공 지식을 활용해 신규 입사자와 협업 구성원이 겪는 사내 문서 탐색 문제를 해결하고자 했습니다.
  
프로젝트에서는 문서 이해와 정보 검색 기술을 활용하여 사용자가 업무에 필요한 정보를 보다 쉽게 찾을 수 있는 챗봇을 구현했습니다.
